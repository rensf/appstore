...
VALUES ('1', '神奇宝贝', '图鉴', '神奇宝贝图鉴——汇聚了所有已出现神奇宝贝的详细信息！', '', '', '', '', '', '', NOW(), '1'),
       ('2', '育婴宝', '幼儿', '精准满足中国年轻父母知识获取、交流交友、记录成长、消费购物的四大核心需求，从而培养健康、友爱、智慧、勇敢的宝宝们!', '', '', '', '', '', '', NOW(),
        '1'),
       ('3', '作业消消乐', '游戏', '趣味十足，操作简单，老少皆宜，玩法丰富！', '', '', '', '', '', '', NOW(), '1'),
       ('4', '咖妃', '餐饮', '用每一杯咖啡传递独特的咖妃！', '', '', '', '', '', '', NOW(), '1');
